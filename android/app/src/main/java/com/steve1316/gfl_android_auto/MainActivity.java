...
public class MainActivity extends ReactActivity {
    public static final String loggerTag = "[GFL]";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AppUpdater(this)
                ...
                .setUpdateXML("https://raw.githubusercontent.com/steve1316/gfl-android-auto/main/android/app/update.xml")
                .start();
